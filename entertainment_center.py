...
the_shawshank_redemption = media.Movie("The Shawshank Redemption",
                                       ...
                                       "Rated: " +
                                       str(media.Movie.VALID_RATINGS[3]),
...
guardians_of_the_galaxy = media.Movie("Guardians of the Galaxy",
                                      ...
                                      "Rated: " +
                                      str(media.Movie.VALID_RATINGS[2]),
...
movies = [toy_story, avatar, the_shawshank_redemption, doctor_strange, fantastic_beasts_and_where_to_find_them,
          guardians_of_the_galaxy, deadpool, warcraft, the_hateful_eight, finding_dory, fury, interstellar]
